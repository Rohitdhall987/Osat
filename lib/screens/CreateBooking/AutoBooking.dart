...
class AutoBooking extends StatefulWidget {
  const AutoBooking({super.key});

  @override
  State<AutoBooking> createState() => _AutoBookingState();
}

class _AutoBookingState extends State<AutoBooking> {
  ...
  Future<void> fetchEstimatedPrice() async {
    ...
    final url = Uri.https(
      dotenv.env['DOMAIN']!,
      "/api/user/GetAutoEstimateRidePrice",
      {"text": "fromLocation"},
    );
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                //   TextSpan(
                //     children: [
                //       TextSpan(text: "Distance ", style:TextStyle(fontSize: 16, color: Colors.grey[600]) ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pop();
                        createBooking(distance,totalPrice.toString()); // Proceed to book the bike
                      },
                    ),
                  ],
                ),
